        ...
        <form onSubmit={handleSubmit} method='get' className='p-6 flex flex-col min-w-full'>
          ...
          <div className='flex flex-col justify-start'>
            <div className='my-2 flex flex-col'>
              <label className='text-xs' htmlFor='product_name'>Date</label>
              
              {/* <input id="product_name" type="text" placeholder={`MM/DD/YYYY`} value={`${getCurrentDate()}`} className="input input-bordered  w-full max-w-xs" />
                     */}
            </div>
            <div className='my-2 flex flex-col'>
