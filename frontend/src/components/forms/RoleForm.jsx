...
const RoleForm = ({ onClose }) => {
  ...
  const refreshRolePerm = () => {
    if (selectedRoleType) {
      ...
      setPermissions({
        ...
        modifyExpensesType:
          selectedRoleType.permissions.includes("modifyExpensesType"),
        modifyProductCategory: selectedRoleType.permissions.includes(
          "modifyProductCategory"
        ),
        modifyWarehouses:
          selectedRoleType.permissions.includes("modifyWarehouses"),
        ...
        modifyPlatforms:
          selectedRoleType.permissions.includes("modifyPlatforms"),
      });
    }
  };
  ...
  const handleEdit = async () => {
    if (
      selectedRoleType &&
      selectedRoleType.roleName.toLowerCase() === "admin"
    ) {
    ...
    if(selectedRoleType.roleName === newRole){
      history_data = {
        timestamp: new Date().toISOString(),
        role: user_role,
        email: user_email,
        action: `Edited Role: ${newRole}`
      }
    }else{
      history_data = {
        timestamp: new Date().toISOString(),
        role: user_role,
        email: user_email,
        action: `Edited Role: ${selectedRoleType.roleName} to ${newRole}`
      }
    }
    ...
    const isInRolesType = roleTypes.some(
      (role) => role.roleName === newRole && role._id !== selectedRoleType._id
    );
  ...
  const handleDelete = async () => {
    ...
    const history_data = {
      ...
      role: user_role,
      email: user_email,
      action: `Deleted Role: ${selectedRoleType.roleName}`
    }

    const isInProductsData = accounts.some(
      (account) => account.role._id === _id
    );

    if (isInProductsData) {
      setError(
        "Cannot delete this role type because it is associated with existing account."
      );
      return;
    }
    try {
            ...
            <div className="mt-2 space-y-3">
              ...
              <div className="flex flex-row">
                <input
                  type="checkbox"
                  className="checkbox checkbox-secondary"
                  value="modifyExpensesType"
                  checked={permissions.modifyExpensesType}
                  onChange={handleCheckboxChange}
                />
              ...
              <div className="flex flex-row">
                <input
                  type="checkbox"
                  className="checkbox checkbox-secondary"
                  value="modifyProductCategory"
                  checked={permissions.modifyProductCategory}
                  onChange={handleCheckboxChange}
                />
              ...
              <div className="flex flex-row">
                <input
                  type="checkbox"
                  className="checkbox checkbox-secondary"
                  value="modifyWarehouses"
                  checked={permissions.modifyWarehouses}
                  onChange={handleCheckboxChange}
                />
              ...
              <div className="flex flex-row">
                <input
                  type="checkbox"
                  className="checkbox checkbox-secondary"
                  value="modifyCouriers"
                  checked={permissions.modifyCouriers}
                  onChange={handleCheckboxChange}
                />
              ...
              <div className="flex flex-row">
                <input
                  type="checkbox"
                  className="checkbox checkbox-secondary"
                  value="modifyPlatforms"
                  checked={permissions.modifyPlatforms}
                  onChange={handleCheckboxChange}
                />
              ...
              <div className="flex flex-row">
                <input
                  ...
                  checked={permissions.roleManagement}
                  onChange={handleCheckboxChange}
                />
              ...
              <div className="flex flex-row">
                <input
                  type="checkbox"
                  className="checkbox checkbox-secondary"
                  value="recordsHistory"
                  checked={permissions.recordsHistory}
                  onChange={handleCheckboxChange}
                />
              ...
              <div className="flex flex-row">
                <input
                  type="checkbox"
                  className="checkbox checkbox-secondary"
                  value="modifyAccounts"
                  checked={permissions.modifyAccounts}
                  onChange={handleCheckboxChange}
                />
            ...
            <dialog id="my_modal_1" className="modal">
              <div className="modal-box">
                ...
                <p className="py-4 pb-0 text-left">
                  This action will delete your role!
                </p>
